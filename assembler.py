...
instructions = {"add": '00000', "sub": '00001', "cmp": '00101', "ld": '01110', "st": '01111', "beq": '10000', "call": '10011', "ret": '10100', "nop": '01101', "halt": '11111', "and": '00110', "or": '00111'}
...
sz = len(st)
for line in st:
    g.write(hex(count)[2 : ].zfill(math.ceil(math.log(sz,16))) + ': ' + encode(bin_to_hex(inst_to_bin(line))) + '\n')
    count += 4
f.close()
g.close()